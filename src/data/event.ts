...
export const highlightsContent = {
  items: [
    ...
    {
      title: "Exposure and ecosystem access",
      description:
...
export const agendaContent = {
  ...
  timeline: [
    ...
    {
      date: "9 May 2026",
      title: "Final Pitch Day + Networking",
      format: "Live event",
      description:
        "Selected finalist teams pitch live, followed by broader community engagement and networking.",
    },
  ],
  note: "On-site registration is also available during the Team-Up Info Session on 10 April 2026.",
...
export const organiserContent = {
  eyebrow: "Organiser",
  title: "Delivered with academic support and community backing",
  description:
  ...
  morePartnersNote: "More partners to be announced.",
};

export const formContent = {
  eyebrow: "Register",
  title: "Apply to compete or register your interest",
  description:
  ...
  eoiCard: {
    title: "Audience / Partnership Interest",
    description:
  ...
  formspreeAction: "https://formspree.io/f/mykbwrne",
  interestOptions: [
